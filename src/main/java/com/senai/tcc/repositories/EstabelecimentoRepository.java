...
public interface EstabelecimentoRepository extends JpaRepository<Estabelecimento, Long> {
	...
	@Query(value = "select * from estabelecimento " + " where ativo = 'S' limit 3", nativeQuery = true)
	List<Estabelecimento> obterAcessados();

	@Query(value = "Select * \r\n" + "FROM estabelecimento limit 3\r\n"
	...
	@Query(value = "select * from estabelecimento, endereco " + "where ativo = 'S' and "
			...
			+ " (localidade like %:localidade% or :localidade is null) limit 3", nativeQuery = true)
